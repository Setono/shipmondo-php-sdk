...
final class SalesOrder implements \JsonSerializable
{
    public function __construct(
        ...
        public ?int $returnShipment_templateId = null,
        public ?int $salesOrder_packagingId = null,
    ...
    public function jsonSerialize(): array
    {
        return array_filter([
            ...
            'return_shipment_template_id' => $this->returnShipment_templateId,
            'sales_order_packaging_id' => $this->salesOrder_packagingId,
